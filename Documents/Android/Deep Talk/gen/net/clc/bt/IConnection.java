 ...
 * Original file: /Users/deadmau/Documents/Android/Deep Talk/src/net/clc/bt/IConnection.aidl
 */
package net.clc.bt;
...
public static abstract class Stub extends android.os.Binder implements net.clc.bt.IConnection
{
private static final java.lang.String DESCRIPTOR = "net.clc.bt.IConnection";
...
/**
 * Cast an IBinder object into an net.clc.bt.IConnection interface,
 * generating a proxy if needed.
 */
public static net.clc.bt.IConnection asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof net.clc.bt.IConnection))) {
return ((net.clc.bt.IConnection)iin);
}
return new net.clc.bt.IConnection.Stub.Proxy(obj);
}
...
java.lang.String _arg0;
_arg0 = data.readString();
net.clc.bt.IConnectionCallback _arg1;
_arg1 = net.clc.bt.IConnectionCallback.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements net.clc.bt.IConnection
{
...
@Override public int registerCallback(java.lang.String srcApp, net.clc.bt.IConnectionCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
public int registerCallback(java.lang.String srcApp, net.clc.bt.IConnectionCallback cb) throws android.os.RemoteException;
