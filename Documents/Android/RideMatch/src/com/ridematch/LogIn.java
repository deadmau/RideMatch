...
public class LogIn extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // Set up the request button click handler
    ((Button) findViewById(R.id.request_button)).setOnClickListener(new OnClickListener() {
      public void onClick(View v) {
    	  // Start and intent for the request user information activity
          Intent intent = new Intent(LogIn.this, RequestUserInfo.class);
          startActivity(intent);
      }
    });
  }
